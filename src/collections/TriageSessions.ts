...
export const TriageSessions: CollectionConfig = {
  ...
  // NOTE: createdAt is auto-generated by Payload timestamps. The PostgreSQL
  // adapter does not auto-index it — add a migration index on createdAt for
  // dashboard query performance (ORDER BY / date-range filters).
  ...
  fields: [
    ...
    { name: 'isCrisis', type: 'checkbox', defaultValue: false,
      admin: { description: 'True when a BH triage escalation triggered the 988 crisis screen' } },
  ],
}
