    ...
    <footer className="px-4 py-6 text-center text-sm text-gray-500 border-t border-gray-200">
      <div className="mb-4">
        <button
          ...
          aria-expanded={open}
          className="text-xs text-gray-400 hover:text-gray-600 underline focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-gray-400"
        >
          {d('heading')} {open ? '▲' : '▼'}
        </button>

        {open && (
          <ul className="mt-2 mx-auto max-w-md space-y-1 text-left text-xs text-gray-400 list-disc list-inside">
